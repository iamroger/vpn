...
3. start SSL handshake //should deleted
4. send auth message to server //should deleted
...
4. start SSL handshake //should deleted
5. wait for auth message from client (S_WAIT_AUTH) //should modified, auth server send auth msg to server
6. send auth message to client //should deleted, auth server send
